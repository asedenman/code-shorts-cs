...
namespace System.Collections.Generic
{
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        public PriorityQueue(int initialCapacity, IComparer<TPriority>? comparer)
        {
            if (initialCapacity < 0)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(initialCapacity), initialCapacity, "Argument out of range: need non-negative capacity.");
            }
        ...
        public PriorityQueue(IEnumerable<(TElement Element, TPriority Priority)> items, IComparer<TPriority>? comparer)
        {
            ...
            //TODO get MS implementation of enumberable helpers
        ...
        public int EnsureCapacity(int capacity)
        {
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(capacity), capacity, "Argument out of range, need non-negative capacity.");
            }
        ...
        private void Grow(int minCapacity)
        {
            ...
            if ((uint)newcapacity > System.Int32.MaxValue) newcapacity = Int32.MaxValue;
        ...
        public sealed class UnorderedItemsCollection : IReadOnlyCollection<(TElement Element, TPriority Priority)>, ICollection
        {
            ...
            void ICollection.CopyTo(Array array, int index)
            {
                ...
                if (array.Rank != 1)
                {
                    throw new ArgumentException("Multi-dimensional array not supported", nameof(array));
                }
                ...
                {
                    throw new ArgumentOutOfRangeException(nameof(index), index,"Argument out of range: index");
                }

                if (array.Length - index < _queue._size)
                {
                    throw new ArgumentException("Array not long enough to hold queue.");
                }
                ...
                {
                    throw new ArgumentException("Array of invalid type for queue.", nameof(array));
                }
            }
            ...
            public struct Enumerator : IEnumerator<(TElement Element, TPriority Priority)>
            {
                ...
                private bool MoveNextRare()
                {
                    ...
                    {
                        throw new InvalidOperationException("Enumerable invalidated: queue version not equal.");
                    }
